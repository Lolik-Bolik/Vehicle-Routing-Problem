...
if __name__ == '__main__':
    ...
    if make_csv:
        statistic = open('statistic_no_opt.csv', 'w')
        columns_names = ['File name', 'Number of Locations', 'Number of trucks', 'Capacity', 'Optimal', 'Achieved',
                         '2-opt', 'Routes', 'Work time']
    ...
    for file in tqdm(files):
        ...
        os.makedirs('solutions_loc_glob_no_opt', exist_ok=True)
        with open(f'solutions_loc_glob_no_opt/{name}.sol', 'w') as sol_fp:
